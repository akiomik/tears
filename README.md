...
An edit is not finished until the file's own documentation has been read
again and corrected where the change made it false: the module doc, the doc
on the item, the comment over the line.
